...
import {
  ConsoleLogSink,
  type ConsoleTarget,
} from "../../src/adapters/console/ConsoleLogSink.js";
import type {
  LogEntry,
  LogSeverity,
...
describe("ConsoleLogSink", () => {
  ...
  it("keeps structured context expandable without printing an empty object", () => {
    ...
    expect(vi.mocked(target.info).mock.calls[1]).toHaveLength(7);
  });
});
